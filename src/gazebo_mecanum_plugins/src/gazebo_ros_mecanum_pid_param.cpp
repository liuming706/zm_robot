...
void pid_callback(gazebo_mecanum_plugins::gazebo_mecanum_plugins_pidConfig &config,
                  uint32_t level)
{
...
int main(int argc, char **argv)
{
    ...
    dynamic_reconfigure::Server<
        gazebo_mecanum_plugins::gazebo_mecanum_plugins_pidConfig>::CallbackType f;

    ros::Publisher gazebo_ros_mecanum_pid =
        n.advertise<gazebo_mecanum_plugins::gazebo_mecanum_plugins_pid>(
            "gazebo_mecanum_plugins_PID", 50);
